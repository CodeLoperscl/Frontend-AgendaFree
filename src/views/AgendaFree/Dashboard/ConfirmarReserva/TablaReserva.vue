  ...
  axios.get(api+"/api/cita")
    .then((response)=>{
      if(response){
        ...
        citasEspecialista.value = citasEspecialista.value.map((cita)=>{
          return {
            id: cita.id,
                  ...
                  <template #default="{ row }">
                    <tr>
                      ...
                      <td>
                        ...
                        >
                          <span class="d-none d-lg-inline">Solicitud abono</span>
                        ...
                        >
                          <span class="d-none d-lg-inline">Reservar</span>
